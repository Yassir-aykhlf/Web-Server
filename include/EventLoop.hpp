...
private:
    ...
    std::map<int, unsigned long long> _clientBirthOrder;
    unsigned long long _nextClientBirthOrder;
    ...
    bool readAllAvailableData(int pipeFd, std::string &outputBuffer, bool &readError);
    ...
    int findOldestEvictableClientPollIndex() const;
    bool evictOldestKeepAliveClient();
